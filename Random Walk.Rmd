...
Análisando o grafo podemos notar que os estados {0,1,2,3,4} são uma classe fechada, finita e recorrente.
...
Ou seja, para passeio aleatórios simétricos em dimensão 1 e 2, todos os estados serão recorrentes.

Falta provar que é recorrente nulo!
